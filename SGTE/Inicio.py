...
def init_session_state():
    ...
    defaults = {
        ...
        'sidebar_collapsed': False  # Control del sidebar
    }
...
def get_dashboard_metrics():
    ...
    try:
        ...
        metrics = contar_estudiantes_por_estado()
        return metrics
...
def main():
    ...
    # Ahora importamos render_global_sidebar
    from services.ui import inject_custom_css, render_hero, render_metric_card, render_global_sidebar
    
    # Inyectar estilos CSS personalizados
    inject_custom_css()
    
    # Renderizar Sidebar Global (identico en todas las páginas)
    render_global_sidebar(current_page="Inicio")
